...
export const metadata = {
    title: 'Warranty Policy | Cell Tech BD',
    description: 'Learn about our warranty policy for electronics and gadgets purchased from Cell Tech BD.',
};
        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16 space-y-10">
                <section>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">All products sold through Cell Tech BD come with the manufacturer's official warranty. The warranty period and coverage vary by product and brand. Warranty details are listed on each product page.</p>
